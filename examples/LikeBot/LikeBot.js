...
bot.onCommand(["scoreboard", "anti-scoreboard"], function (command) {
    let display = command.keyword == 'scoreboard' ? 'DESC' : 'ASC';
...
bot.onCommand(["like", "dislike", "love", "hate"], function (command) {
